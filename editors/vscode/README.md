...
[简体中文](https://github.com/zhuanglinsheng/tapas/blob/0.1.0/editors/vscode/README_zh.md) | English | [Project Home](https://github.com/zhuanglinsheng/tapas)
...
After the official release, install **Tapas Language Support** from the Visual
Studio Code Marketplace, or download the VSIX from the GitHub Release and run:

...
简体中文 | [English](https://github.com/zhuanglinsheng/tapas/blob/0.1.0/editors/vscode/README.md) | [项目主页](https://github.com/zhuanglinsheng/tapas)
...
正式发布后，可以从 Visual Studio Code Marketplace 安装 **Tapas Language Support**，也可以下载 GitHub Release 中的 VSIX 并执行：

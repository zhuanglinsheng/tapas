/**
 * @file tobj_array.h
 * @brief Declares the internal resizable array used by execution environments.
 * @details Stores Tapas values with the ownership behavior required by core
 * environment locals and VM-managed object slots.
 * @note This is Tapas-specific storage, not a standalone public container.
 */
#ifndef TAPAS_DSA_TOBJ_ARRAY_H
#define TAPAS_DSA_TOBJ_ARRAY_H

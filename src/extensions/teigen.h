...
void idx(const tobj * params, uint_regs np, tobj& vre)
{
	if (np != 2)
...
void iset(const tobj * params, uint_regs np, const tobj & vright, ttypes tright)
{
	if (np != 2)
...
void iset(const tobj * params, uint_regs np, const tobj& vright)
{
...
inline void to_arr(tobj * const params, uint_regs len, tobj & vre)
{
	if (len != 3)
...
/// random(nrow, ncol)
inline void to_arr_random(tobj* const params, uint_regs len, tobj& vre)
{
	if (len != 2)
...
/// rows(arr)
inline void arr_rows(tobj* const params, uint_regs len, tobj& vre)
{
	if (len != 1)
...
/// cols(arr)
inline void arr_cols(tobj * const params, uint_regs len, tobj & vre)
{
	if (len != 1)
...
/// t(arr)
inline void arr_transpose(tobj * const params, uint_regs len, tobj & vre)
{
	if (len != 1)
...
inline arr_corner
get_arr_corner_params(tobj * const params, uint_regs len)
{
	if (len != 3)
...
inline arr_border get_arr_border_params(tobj * const params, uint_regs len)
{
	if (len != 2)
		twarn(ErrRuntime_ParamsCtr).warn("arr_topright", "2 Parameters");
...
/// topright(arr, p, q)
inline void arr_topright(tobj * const params, uint_regs len, tobj & vre)
{
...
/// topleft(arr, p, q)
inline void arr_topleft(tobj * const params, uint_regs len, tobj & vre)
{
	arr_corner ps = get_arr_corner_params(params, len);
...
/// bottomright(arr, p, q)
inline void arr_bottomright(tobj * const params, uint_regs len, tobj & vre)
{
	arr_corner ps = get_arr_corner_params(params, len);
...
/// bottomleft(arr, p, q)
inline void arr_bottomleft(tobj * const params, uint_regs len, tobj & vre)
{
	arr_corner ps = get_arr_corner_params(params, len);
...
/// top(arr, p)
inline void arr_toprows(tobj * const params, uint_regs len, tobj & vre)
{
...
/// bottom(arr, p)
inline void arr_bottomrows(tobj * const params, uint_regs len, tobj & vre)
{
	arr_border ps = get_arr_border_params(params, len);
...
/// left(arr, p)
inline void arr_leftcols(tobj * const params, uint_regs len, tobj & vre)
{
	arr_border ps = get_arr_border_params(params, len);
...
/// right(arr, p)
inline void arr_rightcols(tobj * const params, uint_regs len, tobj & vre)
{
	arr_border ps = get_arr_border_params(params, len);
...
void eigf_wrapper(tobj * const params, uint_regs len, tobj & vre,
...
/// abs(v)
inline void arr_abs(tobj * const params, uint_regs len, tobj & vre)
{
	eigf_wrapper<double, tdarr>(params, len, vre, "arr_abs", &std::abs, &eigf_abs);
}

/// eleinv(v)
inline void arr_eleinv(tobj * const params, uint_regs len, tobj & vre)
{
	if (len != 1)
...
/// conjugate(v)
inline void arr_conjugate(tobj * const params, uint_regs len, tobj & vre)
{
	if (len != 1)
...
/// exp(v)
inline void arr_exp(tobj * const params, uint_regs len, tobj & vre)
{
	eigf_wrapper<double, tdarr>(params, len, vre, "arr_exp", &std::exp, &eigf_exp);
}

/// log(v)
inline void arr_log(tobj * const params, uint_regs len, tobj & vre)
{
	eigf_wrapper<double, tdarr>(params, len, vre, "arr_log", &std::log, &eigf_log);
}

/// log1p(v)
inline void arr_log1p(tobj * const params, uint_regs len, tobj & vre)
{
	eigf_wrapper<double, tdarr>(params, len, vre, "arr_log1p", &std::log1p, &eigf_log1p);
}

/// log10(v)
inline void arr_log10(tobj * const params, uint_regs len, tobj & vre)
{
	eigf_wrapper<double, tdarr>(params, len, vre, "arr_log10", &std::log1p, &eigf_log10);
}

/// pow(v)
inline void arr_pow(tobj * const params, uint_regs len, tobj & vre)
{
	if (len != 2)
...
/// sqrt(v)
inline void arr_sqrt(tobj * const params, uint_regs len, tobj & vre)
{
	eigf_wrapper<double, tdarr>(params, len, vre, "arr_sqrt", &std::sqrt, &eigf_sqrt);
}

/// rsqrt(v)
inline void arr_rsqrt(tobj * const params, uint_regs len, tobj & vre)
{

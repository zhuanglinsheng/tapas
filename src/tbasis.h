...
/// Version the current edition
#define Tap_Version     "1.0"

/// Year the current edition
#define Tap_Year        "2021"

/// Author the current edition
#define Tap_Author      "zhuanglinsheng@outlook.com"

/// Composition of Basic version infos
...
/// We say integer is infinity if it is greater that Tap_LONG_MAX
#define Tap_Long_MAX (2e31-1)

/// Alias for uint64_t, used in tapas::tcp
typedef uint64_t uint_lexs;

/// Alias for int64_t, used in tapas::tlex_ctr
...
#define Limit_L static_cast<uint16_t>(8191)
...
/// Alias for R_Limit (   262,143), the limit of constants list.
